...
class HomeLocalDataSourceImpl(
    ...
    override suspend fun saveMoviesForCategory(
    ...
    override fun observeMoviesByCategory(category: ContentCategory): Flow<List<ContentEntity>> = dao.observeCategory(category)
